class UserRepository {
  ...
  async getNotificationPreferences() { throw new Error('UserRepository.getNotificationPreferences no implementado'); }
  async updateNotificationPreferences() { throw new Error('UserRepository.updateNotificationPreferences no implementado'); }
