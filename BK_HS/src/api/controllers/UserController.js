...
const { UpdateNotificationPreferencesRequest } = require('../../core/application/dtos/requests/UpdateNotificationPreferencesRequest');
const { UserResponse } = require('../../core/application/dtos/responses/UserResponse');
class UserController {
  constructor({ getCurrentUser, updateCurrentUser, getUserPreferences, updateUserPreferences, getNotificationPreferences, updateNotificationPreferences, getAuthorizationContext, accountAdminService }) { this.getCurrentUser = getCurrentUser; this.updateCurrentUser = updateCurrentUser; this.getUserPreferences = getUserPreferences; this.updateUserPreferences = updateUserPreferences; this.getNotificationPreferences = getNotificationPreferences; this.updateNotificationPreferences = updateNotificationPreferences; this.getAuthorizationContext = getAuthorizationContext; this.accountAdminService = accountAdminService; }
  ...
  async getNotificationPreferences(req, res) { const preference = await this.getNotificationPreferences.execute(req.user.id); res.json({ data: preference }); }
  async updateNotificationPreferences(req, res) { const input = UpdateNotificationPreferencesRequest.fromRequest(req.body); const preference = await this.updateNotificationPreferences.execute({ userId: req.user.id, ...input }); res.json({ data: preference }); }
