-- ============================================================
-- PATCH: fix_user_account_delete_audit_trigger
-- DOMINIO: user_account / audit
-- PROPÓSITO: Asegura que DELETE sobre user_account no falle por la auditoría
-- ============================================================
...
BEGIN
    ...
    -- En caso de DELETE, si no hay usuario activo en sesión (v_user_id es NULL),
    -- registrar como NULL para evitar FK constraint que podría fallar si el usuario se autoelimina.
    INSERT INTO audit.audit_log (
        ...
        CASE WHEN TG_OP = 'DELETE' AND v_user_id IS NULL
            THEN NULL
