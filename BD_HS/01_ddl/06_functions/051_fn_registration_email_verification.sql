-- El alta queda pendiente y el consumo del token activa la cuenta.
...
BEGIN
    ...
    INSERT INTO user_account.user_account (username, email, status)
    VALUES (v_username, v_email, 'Pending')
...
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'El token de verificacion no es valido o expiro';
    END IF;
